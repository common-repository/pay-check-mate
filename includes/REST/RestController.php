...
class RestController extends WP_REST_Controller {
    ...
    public function get_collection_params(): array {
        return [
            'search'   => [
                'description'       => __( 'Limit results to those matching a string.', 'pay-check-mate' ),
                'type'              => 'string',
            ...
            'page'     => [
                'description'       => __( 'Current page of the collection.', 'pay-check-mate' ),
                'type'              => 'integer',
            ...
            'per_page' => [
                'description'       => __( 'Maximum number of items to be returned in result set.', 'pay-check-mate' ),
                'type'              => 'integer',
                'sanitize_callback' => 'sanitize_text_field',
                'validate_callback' => 'rest_validate_request_arg',
                'default'           => 10,
            ...
            'order_by'  => [
                'description'       => __( 'Sort collection by object attribute.', 'pay-check-mate' ),
                'type'              => 'string',
            ...
            'order'    => [
                'description'       => __( 'Order sort attribute ascending or descending.', 'pay-check-mate' ),
                'type'              => 'string',
                'sanitize_callback' => 'sanitize_key',
                'validate_callback' => 'rest_validate_request_arg',
                'default'           => 'desc',
            ...
            'status'   => [
                'description'       => __( 'Limit result set to items with a specific status.', 'pay-check-mate' ),
                'type'              => 'string',
                'sanitize_callback' => 'absint',
                'validate_callback' => 'rest_validate_request_arg',
            ],
